    ...
    def get_global_unified_color(value, method='kriging'):
        ...
        if method == 'indicator_kriging':
            ...
            colormap_palettes = {
                ...
                'mako': [
                    '#0b0405', '#1a0b1e', '#2d1b3d', '#3f2e5a', '#4b4271', '#555584', '#5e6a94', '#677fa2',
                    '#7094ad', '#7aa9b6', '#85bebc', '#92d3c0', '#a2e7c2', '#b5fbc2', '#ccffc0', '#e8ffb8',
                    '#ffffaa', '#ffff96', '#ffff82', '#ffff6e', '#ffff5a', '#ffff46', '#ffff32', '#ffff1e',
                    '#ffff0a', '#fffb00', '#fff100', '#ffe700', '#ffdd00', '#ffd300', '#ffc900', '#ffbf00',
                    '#ffb500', '#ffab00', '#ffa100', '#ff9700', '#ff8d00', '#ff8300', '#ff7900', '#ff6f00'
                ],
                'viag': [
